...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/discorpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14625&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/discorpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `discorpy` can be installed with:

```
conda install discorpy
```

It is possible to list all of the versions of `discorpy` available on your platform with:
